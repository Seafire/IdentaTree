...
public class AudioMaster : MonoBehaviour 
{
	...
	{
		AkSoundEngine.LoadBank ("Enemy_SoundBank",AkSoundEngine.AK_DEFAULT_POOL_ID, out bankID);
		AkSoundEngine.LoadBank ("PickUps_SoundBank",AkSoundEngine.AK_DEFAULT_POOL_ID, out bankID);
		AkSoundEngine.LoadBank ("UI_SoundBank",AkSoundEngine.AK_DEFAULT_POOL_ID, out bankID);
		AkSoundEngine.LoadBank ("Music_Level_01_SoundBank",AkSoundEngine.AK_DEFAULT_POOL_ID, out bankID);
	}
